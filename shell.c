...
/*
    Func declarations for builtin commands
*/
...
//list of builtin cmds, followed by functions
...
int lsh_help(char **args){
    int i;
    printf("Welcome to the Brinegamers Shell\n");
...
int lsh_execute(char **args)
{
    ...
    for (i = 0; i < lsh_num_builtins(); i++){
        if(stromp(args[0], builtin_str[i]) == 0){
